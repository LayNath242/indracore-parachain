...
use kumandra_parachain_primitives::*;
...
// XCM imports
use indracore_parachain::primitives::Sibling;
...
parameter_types! {
    pub const KumandraLocation: MultiLocation = MultiLocation::X1(Junction::Parent);
...
construct_runtime! {
    pub enum Runtime where
        Block = Block,
        NodeBlock = kumandra_parachain_primitives::Block,
